...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Sales",
    subItems: [
      { name: "Report Sales", path: "/blank", pro: false },
      { name: "Pos", path: "/error-404", pro: false },
    ],
  },
  {
    icon: <BoxCubeIcon />,
  ...
  },
  {
    ...
    name: "Finance",
    subItems: [
      { name: "Jurnal", path: "/blank", pro: false },
      { name: "Laporan Keuangan", path: "/basic-tables", pro: false },
      { name: "User", path: "/userPage", pro: false },
    ],
  },
];
